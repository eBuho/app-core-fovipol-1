...
public class AdmUsuarioRol implements Serializable {
    ...
    @Id
    @TableGenerator(name = "secAdmUsuarioRol",table = "SIFO.adm_secuencia",valueColumnName = "gene_val", pkColumnName = "iden_gene_tab",pkColumnValue = "ADM_USUARIO_ROL", allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.TABLE, generator="secAdmUsuarioRol")
    @Basic(optional = false)
    @NotNull
    @Column(name = "IDEN_USUA_URO", updatable=false)
