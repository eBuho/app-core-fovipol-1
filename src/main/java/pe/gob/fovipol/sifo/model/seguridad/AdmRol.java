...
public class AdmRol implements Serializable {
    ...
    @Id
    @TableGenerator(name = "secAdmRol",table = "SIFO.adm_secuencia",valueColumnName = "gene_val", pkColumnName = "iden_gene_tab",pkColumnValue = "ADM_ROL", allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.TABLE, generator="secAdmRol")
    @Basic(optional = false)
    @NotNull
    @Column(name = "IDEN_ROLE_ROL", updatable=false)
