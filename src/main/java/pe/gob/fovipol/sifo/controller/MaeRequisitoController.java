...
public class MaeRequisitoController implements Serializable {
    ...
    protected void initializeEmbeddableKey() {
        selected.setMaeRequisitoPK(new pe.gob.fovipol.sifo.model.maestros.MaeRequisitoPK());
    }
    ...
    public static class MaeRequisitoControllerConverter implements Converter {
        ...
        pe.gob.fovipol.sifo.model.maestros.MaeRequisitoPK getKey(String value) {
            pe.gob.fovipol.sifo.model.maestros.MaeRequisitoPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new pe.gob.fovipol.sifo.model.maestros.MaeRequisitoPK();
            return key;
        }

        String getStringKey(pe.gob.fovipol.sifo.model.maestros.MaeRequisitoPK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getIdenProcPrc());
            sb.append(SEPARATOR);
            sb.append(value.getSecuMaeReq());
            return sb.toString();
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof MaeRequisito) {
                ...
                return getStringKey(o.getMaeRequisitoPK());
            } else {
