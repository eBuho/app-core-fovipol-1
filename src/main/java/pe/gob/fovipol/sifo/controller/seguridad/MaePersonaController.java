...
import pe.gob.fovipol.sifo.dao.seguridad.MaePersonaFacade;
...
@Named("maePersonaController")
@SessionScoped
public class MaePersonaController implements Serializable {

    @EJB
    private pe.gob.fovipol.sifo.dao.seguridad.MaePersonaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Seguridad").getString("MaePersonaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Seguridad").getString("MaePersonaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Seguridad").getString("MaePersonaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public MaePersona getMaePersona(java.math.BigDecimal id) {
    ...
    public static class MaePersonaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getMaePersona(getKey(value));
        }
